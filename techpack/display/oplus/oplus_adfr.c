...
void oplus_adfr_init(struct dsi_panel *panel)
{
	...
	/* Tsurugi: Force enable ADFR for dynamic 60/120Hz switching */
	oplus_adfr_config |= (OPLUS_ADFR_CONFIG_GLOBAL | OPLUS_ADFR_CONFIG_VSYNC_SWITCH | 
			      OPLUS_ADFR_CONFIG_FAKEFRAME | OPLUS_ADFR_CONFIG_VSYNC_SWITCH_MODE);
